...
- (void)observeCallback:(void (^ _Nonnull)(NSURL * _Nonnull))block;
- (void)removeCallbackNotificationObserver;
- (void)cancel;
- (void)putHandle:(id <OAuthSwiftRequestHandle> _Nonnull)handle withKey:(NSString * _Nonnull)key;
+ (void)mainWithBlock:(void (^ _Nonnull)(void))block;
...
@property (nonatomic, copy) NSString * _Nonnull consumerKey;
@property (nonatomic, copy) NSString * _Nonnull consumerSecret;
@property (nonatomic, copy) NSString * _Nonnull requestTokenUrl;
@property (nonatomic, copy) NSString * _Nonnull authorizeUrl;
@property (nonatomic, copy) NSString * _Nonnull accessTokenUrl;
...
- (nonnull instancetype)initWithConsumerKey:(NSString * _Nonnull)consumerKey consumerSecret:(NSString * _Nonnull)consumerSecret SWIFT_UNAVAILABLE;
@end
...
@property (nonatomic, copy) NSString * _Nonnull consumerSecret;
@property (nonatomic, copy) NSString * _Nonnull authorizeUrl;
@property (nonatomic, copy) NSString * _Nullable accessTokenUrl;
@property (nonatomic, copy) NSString * _Nonnull responseType;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull separator;)
+ (NSString * _Nonnull)separator;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSData * _Nonnull separatorData;)
+ (NSData * _Nonnull)separatorData;
+ (void)setSeparatorData:(NSData * _Nonnull)value;
...
@property (nonatomic, copy) NSString * _Nonnull oauthVerifier;
...
- (nonnull instancetype)initWithRequest:(NSURLRequest * _Nonnull)request paramsLocation:(enum ParamsLocation)paramsLocation;
- (void)cancel;
...
@interface OAuthWebViewController : WKInterfaceController <OAuthSwiftURLHandlerType>
- (void)handle:(NSURL * _Nonnull)url;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull userActivityType;)
+ (NSString * _Nonnull)userActivityType;
+ (void)setUserActivityType:(NSString * _Nonnull)value;
